...
var drawstr = function(x, y, str, r, g, b, shadow, prng, stylechar) {
    ...
    for (var i = 0; i < str.length; ++i) {
        ...
        if (charcode === stylechar) {
            ...
            if (charcode === 48) { cr = 0; cg = 0; cb = 0; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // 0
            else if (charcode === 49) { cr = 0; cg = 0; cb = 170; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // 1
            else if (charcode === 50) { cr = 0; cg = 170; cb = 0; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // 2
            else if (charcode === 51) { cr = 0; cg = 170; cb = 170; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // 3
            else if (charcode === 52) { cr = 170; cg = 0; cb = 0; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // 4
            else if (charcode === 53) { cr = 170; cg = 0; cb = 170; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // 5
            else if (charcode === 54) { cr = 255; cg = 170; cb = 0; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // 6
            else if (charcode === 55) { cr = 170; cg = 170; cb = 170; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // 7
            else if (charcode === 56) { cr = 85; cg = 85; cb = 85; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // 8
            else if (charcode === 57) { cr = 85; cg = 85; cb = 255; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // 9
            else if (charcode === 97) { cr = 85; cg = 255; cb = 85; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // a
            else if (charcode === 98) { cr = 85; cg = 255; cb = 255; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // b
            else if (charcode === 99) { cr = 255; cg = 85; cb = 85; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // c
            else if (charcode === 100) { cr = 255; cg = 85; cb = 255; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // d
            else if (charcode === 101) { cr = 255; cg = 255; cb = 85; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // e
            else if (charcode === 102) { cr = 255; cg = 255; cb = 255; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // f
            else if (charcode === 107) { cflag = false; fobfus = true; } // k
            else if (charcode === 108) { cflag = false; fbold = true; } // l
            else if (charcode === 109) { cflag = false; fstrike = true; } // m
            else if (charcode === 110) { cflag = false; funder = true; } // n
            else if (charcode === 111) { cflag = false; fitalic = true; } // o
            else if (charcode === 114) { cr = r; cg = g; cb = b; cflag = false; fobfus = false; fbold = false; fstrike = false; funder = false; fitalic = false; } // r
            else { cflag = false; }
        } else {
            if (fobfus) {
                redraw = true;
